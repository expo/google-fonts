# @expo-google-fonts/playwrite-au-tas-guides
...
```sh
npx expo install @expo-google-fonts/playwrite-au-tas-guides expo-font expo-app-loading
```
...
import { useFonts, PlaywriteAUTASGuides_400Regular } from '@expo-google-fonts/playwrite-au-tas-guides';
