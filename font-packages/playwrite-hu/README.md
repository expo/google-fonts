...
```sh
npx expo install @expo-google-fonts/playwrite-hu expo-font expo-app-loading
```
...
import { useFonts, PlaywriteHU_100Thin, PlaywriteHU_200ExtraLight, PlaywriteHU_300Light, PlaywriteHU_400Regular } from '@expo-google-fonts/playwrite-hu';
