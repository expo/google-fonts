...
```sh
npx expo install @expo-google-fonts/tiro-telugu expo-font expo-app-loading
```
...
import { useFonts, TiroTelugu_400Regular, TiroTelugu_400Regular_Italic } from '@expo-google-fonts/tiro-telugu';
