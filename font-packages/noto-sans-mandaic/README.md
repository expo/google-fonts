# @expo-google-fonts/noto-sans-mandaic
...
![publish size](https://flat.badgen.net/packagephobia/publish/@expo-google-fonts/noto-sans-mandaic)
...
```sh
npx expo install @expo-google-fonts/noto-sans-mandaic expo-font expo-app-loading
```
...
import { useFonts, NotoSansMandaic_400Regular } from '@expo-google-fonts/noto-sans-mandaic';
