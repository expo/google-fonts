# @expo-google-fonts/playwrite-es-guides
...
```sh
npx expo install @expo-google-fonts/playwrite-es-guides expo-font expo-app-loading
```
...
import { useFonts, PlaywriteESGuides_400Regular } from '@expo-google-fonts/playwrite-es-guides';
