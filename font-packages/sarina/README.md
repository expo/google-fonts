...
```sh
npx expo install @expo-google-fonts/sarina expo-font
```
...
import { useFonts } from '@expo-google-fonts/sarina/useFonts';
import { Sarina_400Regular } from '@expo-google-fonts/sarina/400Regular';
