...
```sh
npx expo install @expo-google-fonts/allerta expo-font
```
...
import { useFonts } from '@expo-google-fonts/allerta/useFonts';
import { Allerta_400Regular } from '@expo-google-fonts/allerta/400Regular';
