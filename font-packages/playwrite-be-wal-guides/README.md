# @expo-google-fonts/playwrite-be-wal-guides
...
```sh
expo install @expo-google-fonts/playwrite-be-wal-guides expo-font expo-app-loading
```
...
import {
  useFonts,
  PlaywriteBEWALGuides_400Regular,
} from '@expo-google-fonts/playwrite-be-wal-guides';
