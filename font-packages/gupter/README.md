...
```sh
npx expo install @expo-google-fonts/gupter expo-font expo-app-loading
```
...
import { useFonts, Gupter_400Regular, Gupter_500Medium, Gupter_700Bold } from '@expo-google-fonts/gupter';
