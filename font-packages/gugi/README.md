...
```sh
expo install @expo-google-fonts/gugi expo-font @use-expo/font
```
...
import { Gugi_Regular400 } from '@expo-google-fonts/gugi';
  ...
  if (!fontsLoaded) {
    ...
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        <Text style={{ fontSize, paddingVertical, fontFamily: 'Gugi_Regular400' }}>
          Gugi_Regular400
        </Text>
      </View>
    );
...
##### Gugi_Regular400
![Gugi_Regular400](./4fbf616bf21ec330d026a7115b7224fe9baf30418cdbb19b26eed6ebcd6ce2cc.ttf.png)
