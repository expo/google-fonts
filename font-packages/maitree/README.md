...
```sh
npx expo install @expo-google-fonts/maitree expo-font expo-app-loading
```
...
import { useFonts, Maitree_200ExtraLight, Maitree_300Light, Maitree_400Regular, Maitree_500Medium, Maitree_600SemiBold, Maitree_700Bold } from '@expo-google-fonts/maitree';
