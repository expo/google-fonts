...
```sh
npx expo install @expo-google-fonts/just-me-again-down-here expo-font expo-app-loading
```
...
import { useFonts, JustMeAgainDownHere_400Regular } from '@expo-google-fonts/just-me-again-down-here';
