# @expo-google-fonts/playwrite-au-qld-guides
...
```sh
npx expo install @expo-google-fonts/playwrite-au-qld-guides expo-font expo-app-loading
```
...
import { useFonts, PlaywriteAUQLDGuides_400Regular } from '@expo-google-fonts/playwrite-au-qld-guides';
