# @expo-google-fonts/noto-sans-old-north-arabian
...
```sh
expo install @expo-google-fonts/noto-sans-old-north-arabian expo-font expo-app-loading
```
...
import {
  useFonts,
  NotoSansOldNorthArabian_400Regular,
} from '@expo-google-fonts/noto-sans-old-north-arabian';
