...
```sh
npx expo install @expo-google-fonts/judson expo-font expo-app-loading
```
...
import { useFonts, Judson_400Regular, Judson_400Regular_Italic, Judson_700Bold } from '@expo-google-fonts/judson';
