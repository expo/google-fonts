...
```sh
npx expo install @expo-google-fonts/stint-ultra-condensed expo-font
```
...
import { useFonts } from '@expo-google-fonts/stint-ultra-condensed/useFonts';
import { StintUltraCondensed_400Regular } from '@expo-google-fonts/stint-ultra-condensed/400Regular';
