...
```sh
npx expo install @expo-google-fonts/playwrite-sk expo-font expo-app-loading
```
...
import { useFonts, PlaywriteSK_100Thin, PlaywriteSK_200ExtraLight, PlaywriteSK_300Light, PlaywriteSK_400Regular } from '@expo-google-fonts/playwrite-sk';
