...
```sh
npx expo install @expo-google-fonts/playwrite-hr expo-font expo-app-loading
```
...
import { useFonts, PlaywriteHR_100Thin, PlaywriteHR_200ExtraLight, PlaywriteHR_300Light, PlaywriteHR_400Regular } from '@expo-google-fonts/playwrite-hr';
