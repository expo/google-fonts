...
```sh
expo install @expo-google-fonts/shojumaru expo-font @use-expo/font
```
...
import { Shojumaru_Regular400 } from '@expo-google-fonts/shojumaru';
  ...
  if (!fontsLoaded) {
    ...
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        <Text style={{ fontSize, paddingVertical, fontFamily: 'Shojumaru_Regular400' }}>
          Shojumaru_Regular400
        </Text>
      </View>
    );
...
##### Shojumaru_Regular400
![Shojumaru_Regular400](./fb8c1c2c57d08ed6f7529a7edaa63995da1703823a076877d46c77f0b984d3f5.ttf.png)
