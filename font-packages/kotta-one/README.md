...
```sh
npx expo install @expo-google-fonts/kotta-one expo-font
```
...
import { useFonts } from '@expo-google-fonts/kotta-one/useFonts';
import { KottaOne_400Regular } from '@expo-google-fonts/kotta-one/400Regular';
