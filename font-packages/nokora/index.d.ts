...
export const Nokora_200ExtraLight: number;
export const Nokora_300Light: number;
export const Nokora_400Regular: number;
export const Nokora_500Medium: number;
export const Nokora_600SemiBold: number;
export const Nokora_700Bold: number;
export const Nokora_800ExtraBold: number;
