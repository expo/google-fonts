...
```sh
npx expo install @expo-google-fonts/staatliches expo-font
```
...
import { useFonts } from '@expo-google-fonts/staatliches/useFonts';
import { Staatliches_400Regular } from '@expo-google-fonts/staatliches/400Regular';
...
||||
|-|-|-|
|![Staatliches_400Regular](./400Regular/Staatliches_400Regular.ttf.png)||||
