...
```sh
npx expo install @expo-google-fonts/jomhuria expo-font
```
...
import { useFonts } from '@expo-google-fonts/jomhuria/useFonts';
import { Jomhuria_400Regular } from '@expo-google-fonts/jomhuria/400Regular';
