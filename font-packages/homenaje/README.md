...
```sh
npx expo install @expo-google-fonts/homenaje expo-font
```
...
import { useFonts } from '@expo-google-fonts/homenaje/useFonts';
import { Homenaje_400Regular } from '@expo-google-fonts/homenaje/400Regular';
...
||||
|-|-|-|
|![Homenaje_400Regular](./400Regular/Homenaje_400Regular.ttf.png)||||
