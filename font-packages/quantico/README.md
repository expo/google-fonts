...
```sh
npx expo install @expo-google-fonts/quantico expo-font expo-app-loading
```
...
import { useFonts, Quantico_400Regular, Quantico_400Regular_Italic, Quantico_700Bold, Quantico_700Bold_Italic } from '@expo-google-fonts/quantico';
