...
```sh
npx expo install @expo-google-fonts/cutive expo-font
```
...
import { useFonts } from '@expo-google-fonts/cutive/useFonts';
import { Cutive_400Regular } from '@expo-google-fonts/cutive/400Regular';
