# @expo-google-fonts/rubik-doodle-shadow
...
```sh
npx expo install @expo-google-fonts/rubik-doodle-shadow expo-font expo-app-loading
```
...
import { useFonts, RubikDoodleShadow_400Regular } from '@expo-google-fonts/rubik-doodle-shadow';
...
||||
|-|-|-|
|![RubikDoodleShadow_400Regular](./RubikDoodleShadow_400Regular.ttf.png)||||
