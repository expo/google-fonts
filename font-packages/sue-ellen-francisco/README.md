# @expo-google-fonts/sue-ellen-francisco
...
```sh
expo install @expo-google-fonts/sue-ellen-francisco expo-font @use-expo/font
```
...
import { SueEllenFrancisco_Regular400 } from '@expo-google-fonts/sue-ellen-francisco';
  ...
  if (!fontsLoaded) {
    ...
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        <Text style={{ fontSize, paddingVertical, fontFamily: 'SueEllenFrancisco_Regular400' }}>
          SueEllenFrancisco_Regular400
        </Text>
      </View>
    );
...
##### SueEllenFrancisco_Regular400
![SueEllenFrancisco_Regular400](./d72aa0c7340b64bd3fc70457dd03d38b35b8cb3fd30f3f1af4a5f9b4bfd870aa.ttf.png)
