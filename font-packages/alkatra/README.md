...
```sh
npx expo install @expo-google-fonts/alkatra expo-font expo-app-loading
```
...
import { useFonts, Alkatra_400Regular, Alkatra_500Medium, Alkatra_600SemiBold, Alkatra_700Bold } from '@expo-google-fonts/alkatra';
