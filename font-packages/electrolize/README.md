...
```sh
npx expo install @expo-google-fonts/electrolize expo-font
```
...
import { useFonts } from '@expo-google-fonts/electrolize/useFonts';
import { Electrolize_400Regular } from '@expo-google-fonts/electrolize/400Regular';
