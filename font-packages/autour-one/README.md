...
```sh
npx expo install @expo-google-fonts/autour-one expo-font
```
...
import { useFonts } from '@expo-google-fonts/autour-one/useFonts';
import { AutourOne_400Regular } from '@expo-google-fonts/autour-one/400Regular';
