...
```sh
npx expo install @expo-google-fonts/arbutus-slab expo-font
```
...
import { useFonts } from '@expo-google-fonts/arbutus-slab/useFonts';
import { ArbutusSlab_400Regular } from '@expo-google-fonts/arbutus-slab/400Regular';
...
||||
|-|-|-|
|![ArbutusSlab_400Regular](./400Regular/ArbutusSlab_400Regular.ttf.png)||||
