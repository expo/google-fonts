...
```sh
npx expo install @expo-google-fonts/dorsa expo-font
```
...
import { useFonts } from '@expo-google-fonts/dorsa/useFonts';
import { Dorsa_400Regular } from '@expo-google-fonts/dorsa/400Regular';
