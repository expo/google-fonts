...
```sh
npx expo install @expo-google-fonts/alice expo-font
```
...
import { useFonts } from '@expo-google-fonts/alice/useFonts';
import { Alice_400Regular } from '@expo-google-fonts/alice/400Regular';
...
||||
|-|-|-|
|![Alice_400Regular](./400Regular/Alice_400Regular.ttf.png)||||
