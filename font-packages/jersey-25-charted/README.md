# @expo-google-fonts/jersey-25-charted
...
```sh
npx expo install @expo-google-fonts/jersey-25-charted expo-font expo-app-loading
```
...
import { useFonts, Jersey25Charted_400Regular } from '@expo-google-fonts/jersey-25-charted';
