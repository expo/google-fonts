...
```sh
npx expo install @expo-google-fonts/nova-flat expo-font
```
...
import { useFonts } from '@expo-google-fonts/nova-flat/useFonts';
import { NovaFlat_400Regular } from '@expo-google-fonts/nova-flat/400Regular';
...
||||
|-|-|-|
|![NovaFlat_400Regular](./400Regular/NovaFlat_400Regular.ttf.png)||||
