...
export const Hanuman_200ExtraLight: number;
export const Hanuman_300Light: number;
export const Hanuman_400Regular: number;
export const Hanuman_500Medium: number;
export const Hanuman_600SemiBold: number;
export const Hanuman_700Bold: number;
export const Hanuman_800ExtraBold: number;
