...
```sh
npx expo install @expo-google-fonts/im-fell-french-canon expo-font expo-app-loading
```
...
import { useFonts, IMFellFrenchCanon_400Regular, IMFellFrenchCanon_400Regular_Italic } from '@expo-google-fonts/im-fell-french-canon';
