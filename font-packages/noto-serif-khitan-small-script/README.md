# @expo-google-fonts/noto-serif-khitan-small-script
...
```sh
npx expo install @expo-google-fonts/noto-serif-khitan-small-script expo-font expo-app-loading
```
...
import { useFonts, NotoSerifKhitanSmallScript_400Regular } from '@expo-google-fonts/noto-serif-khitan-small-script';
