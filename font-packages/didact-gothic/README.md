# @expo-google-fonts/didact-gothic
...
```sh
npx expo install @expo-google-fonts/didact-gothic expo-font
```
...
import { useFonts } from '@expo-google-fonts/didact-gothic/useFonts';
import { DidactGothic_400Regular } from '@expo-google-fonts/didact-gothic/400Regular';
