...
```sh
npx expo install @expo-google-fonts/molle expo-font
```
...
import { useFonts } from '@expo-google-fonts/molle/useFonts';
import { Molle_400Regular_Italic } from '@expo-google-fonts/molle/400Regular_Italic';
