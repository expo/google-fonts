...
```sh
npx expo install @expo-google-fonts/vujahday-script expo-font expo-app-loading
```
...
import { useFonts, VujahdayScript_400Regular } from '@expo-google-fonts/vujahday-script';
