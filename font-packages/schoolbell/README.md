...
```sh
npx expo install @expo-google-fonts/schoolbell expo-font
```
...
import { useFonts } from '@expo-google-fonts/schoolbell/useFonts';
import { Schoolbell_400Regular } from '@expo-google-fonts/schoolbell/400Regular';
