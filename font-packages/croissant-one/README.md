# @expo-google-fonts/croissant-one
...
```sh
npx expo install @expo-google-fonts/croissant-one expo-font
```
...
import { useFonts } from '@expo-google-fonts/croissant-one/useFonts';
import { CroissantOne_400Regular } from '@expo-google-fonts/croissant-one/400Regular';
