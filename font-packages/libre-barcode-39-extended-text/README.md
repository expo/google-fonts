...
```sh
npx expo install @expo-google-fonts/libre-barcode-39-extended-text expo-font
```
...
||||
|-|-|-|
|![LibreBarcode39ExtendedText_400Regular](./400Regular/LibreBarcode39ExtendedText_400Regular.ttf.png)||||
