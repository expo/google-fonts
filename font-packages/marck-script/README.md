# @expo-google-fonts/marck-script
...
```sh
npx expo install @expo-google-fonts/marck-script expo-font
```
...
||||
|-|-|-|
|![MarckScript_400Regular](./400Regular/MarckScript_400Regular.ttf.png)||||
