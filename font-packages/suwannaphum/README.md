...
```sh
npx expo install @expo-google-fonts/suwannaphum expo-font expo-app-loading
```
...
import { useFonts, Suwannaphum_100Thin, Suwannaphum_300Light, Suwannaphum_400Regular, Suwannaphum_700Bold, Suwannaphum_900Black } from '@expo-google-fonts/suwannaphum';
