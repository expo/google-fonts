...
```sh
npx expo install @expo-google-fonts/pt-sans-caption expo-font expo-app-loading
```
...
import { useFonts, PTSansCaption_400Regular, PTSansCaption_700Bold } from '@expo-google-fonts/pt-sans-caption';
