...
```sh
npx expo install @expo-google-fonts/wellfleet expo-font
```
...
import { useFonts } from '@expo-google-fonts/wellfleet/useFonts';
import { Wellfleet_400Regular } from '@expo-google-fonts/wellfleet/400Regular';
...
||||
|-|-|-|
|![Wellfleet_400Regular](./400Regular/Wellfleet_400Regular.ttf.png)||||
