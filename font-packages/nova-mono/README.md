...
```sh
npx expo install @expo-google-fonts/nova-mono expo-font
```
...
import { useFonts } from '@expo-google-fonts/nova-mono/useFonts';
import { NovaMono_400Regular } from '@expo-google-fonts/nova-mono/400Regular';
...
||||
|-|-|-|
|![NovaMono_400Regular](./400Regular/NovaMono_400Regular.ttf.png)||||
