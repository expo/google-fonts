# @expo-google-fonts/noto-sans-lydian
...
![publish size](https://flat.badgen.net/packagephobia/publish/@expo-google-fonts/noto-sans-lydian)
...
```sh
npx expo install @expo-google-fonts/noto-sans-lydian expo-font expo-app-loading
```
...
import { useFonts, NotoSansLydian_400Regular } from '@expo-google-fonts/noto-sans-lydian';
