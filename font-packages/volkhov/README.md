...
```sh
npx expo install @expo-google-fonts/volkhov expo-font expo-app-loading
```
...
import { useFonts, Volkhov_400Regular, Volkhov_400Regular_Italic, Volkhov_700Bold, Volkhov_700Bold_Italic } from '@expo-google-fonts/volkhov';
