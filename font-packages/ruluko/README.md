...
```sh
npx expo install @expo-google-fonts/ruluko expo-font
```
...
import { useFonts } from '@expo-google-fonts/ruluko/useFonts';
import { Ruluko_400Regular } from '@expo-google-fonts/ruluko/400Regular';
