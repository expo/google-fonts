...
```sh
npx expo install @expo-google-fonts/iceland expo-font
```
...
import { useFonts } from '@expo-google-fonts/iceland/useFonts';
...
||||
|-|-|-|
|![Iceland_400Regular](./400Regular/Iceland_400Regular.ttf.png)||||
