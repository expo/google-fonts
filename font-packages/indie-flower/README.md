...
```sh
npx expo install @expo-google-fonts/indie-flower expo-font
```
...
import { useFonts } from '@expo-google-fonts/indie-flower/useFonts';
import { IndieFlower_400Regular } from '@expo-google-fonts/indie-flower/400Regular';
...
||||
|-|-|-|
|![IndieFlower_400Regular](./400Regular/IndieFlower_400Regular.ttf.png)||||
