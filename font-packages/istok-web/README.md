...
```sh
npx expo install @expo-google-fonts/istok-web expo-font expo-app-loading
```
...
import { useFonts, IstokWeb_400Regular, IstokWeb_400Regular_Italic, IstokWeb_700Bold, IstokWeb_700Bold_Italic } from '@expo-google-fonts/istok-web';
