...
```sh
npx expo install @expo-google-fonts/viga expo-font
```
...
import { useFonts } from '@expo-google-fonts/viga/useFonts';
import { Viga_400Regular } from '@expo-google-fonts/viga/400Regular';
