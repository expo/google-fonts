...
```sh
npx expo install @expo-google-fonts/noto-sans-hanifi-rohingya expo-font expo-app-loading
```
...
import { useFonts, NotoSansHanifiRohingya_400Regular, NotoSansHanifiRohingya_500Medium, NotoSansHanifiRohingya_600SemiBold, NotoSansHanifiRohingya_700Bold } from '@expo-google-fonts/noto-sans-hanifi-rohingya';
