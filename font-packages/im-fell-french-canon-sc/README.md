# @expo-google-fonts/im-fell-french-canon-sc
...
```sh
expo install @expo-google-fonts/im-fell-french-canon-sc expo-font @use-expo/font
```
...
import { IMFellFrenchCanonSC_Regular400 } from '@expo-google-fonts/im-fell-french-canon-sc';
