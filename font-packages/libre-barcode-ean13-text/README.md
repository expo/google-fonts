# @expo-google-fonts/libre-barcode-ean13-text
...
```sh
npx expo install @expo-google-fonts/libre-barcode-ean13-text expo-font expo-app-loading
```
...
import { useFonts, LibreBarcodeEAN13Text_400Regular } from '@expo-google-fonts/libre-barcode-ean13-text';
