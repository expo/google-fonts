...
```sh
npx expo install @expo-google-fonts/stix-two-math expo-font
```
...
import { useFonts } from '@expo-google-fonts/stix-two-math/useFonts';
import { STIXTwoMath_400Regular } from '@expo-google-fonts/stix-two-math/400Regular';
...
||||
|-|-|-|
|![STIXTwoMath_400Regular](./400Regular/STIXTwoMath_400Regular.ttf.png)||||
