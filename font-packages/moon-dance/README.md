...
```sh
npx expo install @expo-google-fonts/moon-dance expo-font expo-app-loading
```
...
import { useFonts, MoonDance_400Regular } from '@expo-google-fonts/moon-dance';
