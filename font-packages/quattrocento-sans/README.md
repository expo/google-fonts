...
```sh
npx expo install @expo-google-fonts/quattrocento-sans expo-font expo-app-loading
```
...
import { useFonts, QuattrocentoSans_400Regular, QuattrocentoSans_400Regular_Italic, QuattrocentoSans_700Bold, QuattrocentoSans_700Bold_Italic } from '@expo-google-fonts/quattrocento-sans';
