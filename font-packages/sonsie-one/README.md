...
```sh
npx expo install @expo-google-fonts/sonsie-one expo-font expo-app-loading
```
...
import { useFonts, SonsieOne_400Regular } from '@expo-google-fonts/sonsie-one';
