...
```sh
npx expo install @expo-google-fonts/nova-square expo-font
```
...
import { useFonts } from '@expo-google-fonts/nova-square/useFonts';
import { NovaSquare_400Regular } from '@expo-google-fonts/nova-square/400Regular';
...
||||
|-|-|-|
|![NovaSquare_400Regular](./400Regular/NovaSquare_400Regular.ttf.png)||||
