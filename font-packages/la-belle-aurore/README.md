...
```sh
npx expo install @expo-google-fonts/la-belle-aurore expo-font
```
...
import { useFonts } from '@expo-google-fonts/la-belle-aurore/useFonts';
import { LaBelleAurore_400Regular } from '@expo-google-fonts/la-belle-aurore/400Regular';
...
||||
|-|-|-|
|![LaBelleAurore_400Regular](./400Regular/LaBelleAurore_400Regular.ttf.png)||||
