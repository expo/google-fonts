...
```sh
npx expo install @expo-google-fonts/rochester expo-font
```
...
import { useFonts } from '@expo-google-fonts/rochester/useFonts';
import { Rochester_400Regular } from '@expo-google-fonts/rochester/400Regular';
...
||||
|-|-|-|
|![Rochester_400Regular](./400Regular/Rochester_400Regular.ttf.png)||||
