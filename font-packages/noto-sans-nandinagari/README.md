# @expo-google-fonts/noto-sans-nandinagari
...
```sh
npx expo install @expo-google-fonts/noto-sans-nandinagari expo-font expo-app-loading
```
...
import { useFonts, NotoSansNandinagari_400Regular } from '@expo-google-fonts/noto-sans-nandinagari';
...
||||
|-|-|-|
|![NotoSansNandinagari_400Regular](./NotoSansNandinagari_400Regular.ttf.png)||||
