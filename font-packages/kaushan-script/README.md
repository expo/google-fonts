# @expo-google-fonts/kaushan-script
...
```sh
npx expo install @expo-google-fonts/kaushan-script expo-font
```
...
import { useFonts } from '@expo-google-fonts/kaushan-script/useFonts';
