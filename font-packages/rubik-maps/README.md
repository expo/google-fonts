...
```sh
npx expo install @expo-google-fonts/rubik-maps expo-font expo-app-loading
```
...
import { useFonts, RubikMaps_400Regular } from '@expo-google-fonts/rubik-maps';
