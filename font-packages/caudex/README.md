...
```sh
npx expo install @expo-google-fonts/caudex expo-font expo-app-loading
```
...
import { useFonts, Caudex_400Regular, Caudex_400Regular_Italic, Caudex_700Bold, Caudex_700Bold_Italic } from '@expo-google-fonts/caudex';
