...
```sh
npx expo install @expo-google-fonts/playwrite-es-deco expo-font expo-app-loading
```
...
import { useFonts, PlaywriteESDeco_100Thin, PlaywriteESDeco_200ExtraLight, PlaywriteESDeco_300Light, PlaywriteESDeco_400Regular } from '@expo-google-fonts/playwrite-es-deco';
