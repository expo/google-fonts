...
```sh
npx expo install @expo-google-fonts/rubik-doodle-triangles expo-font expo-app-loading
```
...
import { useFonts, RubikDoodleTriangles_400Regular } from '@expo-google-fonts/rubik-doodle-triangles';
