...
```sh
npx expo install @expo-google-fonts/sofadi-one expo-font
```
...
import { useFonts } from '@expo-google-fonts/sofadi-one/useFonts';
import { SofadiOne_400Regular } from '@expo-google-fonts/sofadi-one/400Regular';
