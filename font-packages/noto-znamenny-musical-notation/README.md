...
```sh
npx expo install @expo-google-fonts/noto-znamenny-musical-notation expo-font expo-app-loading
```
...
import { useFonts, NotoZnamennyMusicalNotation_400Regular } from '@expo-google-fonts/noto-znamenny-musical-notation';
