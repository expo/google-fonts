...
```sh
npx expo install @expo-google-fonts/slabo-27px expo-font
```
...
import { useFonts } from '@expo-google-fonts/slabo-27px/useFonts';
import { Slabo27px_400Regular } from '@expo-google-fonts/slabo-27px/400Regular';
...
||||
|-|-|-|
|![Slabo27px_400Regular](./400Regular/Slabo27px_400Regular.ttf.png)||||
