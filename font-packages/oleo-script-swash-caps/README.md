...
```sh
npx expo install @expo-google-fonts/oleo-script-swash-caps expo-font expo-app-loading
```
...
import { useFonts, OleoScriptSwashCaps_400Regular, OleoScriptSwashCaps_700Bold } from '@expo-google-fonts/oleo-script-swash-caps';
