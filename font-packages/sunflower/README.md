...
```sh
npx expo install @expo-google-fonts/sunflower expo-font expo-app-loading
```
...
import { useFonts, Sunflower_300Light, Sunflower_500Medium, Sunflower_700Bold } from '@expo-google-fonts/sunflower';
