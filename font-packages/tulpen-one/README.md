...
```sh
npx expo install @expo-google-fonts/tulpen-one expo-font
```
...
import { useFonts } from '@expo-google-fonts/tulpen-one/useFonts';
import { TulpenOne_400Regular } from '@expo-google-fonts/tulpen-one/400Regular';
