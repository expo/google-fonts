...
```sh
npx expo install @expo-google-fonts/strait expo-font expo-app-loading
```
...
import { useFonts, Strait_400Regular } from '@expo-google-fonts/strait';
