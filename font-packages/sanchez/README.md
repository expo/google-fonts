...
```sh
npx expo install @expo-google-fonts/sanchez expo-font expo-app-loading
```
...
import { useFonts, Sanchez_400Regular, Sanchez_400Regular_Italic } from '@expo-google-fonts/sanchez';
