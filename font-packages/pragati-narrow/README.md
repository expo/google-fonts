...
```sh
npx expo install @expo-google-fonts/pragati-narrow expo-font expo-app-loading
```
...
import { useFonts, PragatiNarrow_400Regular, PragatiNarrow_700Bold } from '@expo-google-fonts/pragati-narrow';
