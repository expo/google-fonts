# @expo-google-fonts/sixtyfour-convergence
...
```sh
npx expo install @expo-google-fonts/sixtyfour-convergence expo-font expo-app-loading
```
...
import { useFonts, SixtyfourConvergence_400Regular } from '@expo-google-fonts/sixtyfour-convergence';
