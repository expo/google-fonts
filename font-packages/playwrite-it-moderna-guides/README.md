# @expo-google-fonts/playwrite-it-moderna-guides
...
```sh
expo install @expo-google-fonts/playwrite-it-moderna-guides expo-font expo-app-loading
```
...
import {
  useFonts,
  PlaywriteITModernaGuides_400Regular,
} from '@expo-google-fonts/playwrite-it-moderna-guides';
