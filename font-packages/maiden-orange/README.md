...
```sh
npx expo install @expo-google-fonts/maiden-orange expo-font
```
...
import { useFonts } from '@expo-google-fonts/maiden-orange/useFonts';
import { MaidenOrange_400Regular } from '@expo-google-fonts/maiden-orange/400Regular';
