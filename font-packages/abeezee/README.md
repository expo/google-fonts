...
```sh
npx expo install @expo-google-fonts/abeezee expo-font expo-app-loading
```
...
import { useFonts, ABeeZee_400Regular, ABeeZee_400Regular_Italic } from '@expo-google-fonts/abeezee';
