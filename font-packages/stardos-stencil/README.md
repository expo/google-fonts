...
```sh
npx expo install @expo-google-fonts/stardos-stencil expo-font expo-app-loading
```
...
import { useFonts, StardosStencil_400Regular, StardosStencil_700Bold } from '@expo-google-fonts/stardos-stencil';
