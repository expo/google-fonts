# @expo-google-fonts/adlam-display
...
```sh
npx expo install @expo-google-fonts/adlam-display expo-font expo-app-loading
```
...
import { useFonts, ADLaMDisplay_400Regular } from '@expo-google-fonts/adlam-display';
