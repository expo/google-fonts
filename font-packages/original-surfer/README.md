...
```sh
npx expo install @expo-google-fonts/original-surfer expo-font
```
...
import { useFonts } from '@expo-google-fonts/original-surfer/useFonts';
import { OriginalSurfer_400Regular } from '@expo-google-fonts/original-surfer/400Regular';
