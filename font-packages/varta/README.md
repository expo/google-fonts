...
```sh
npx expo install @expo-google-fonts/varta expo-font expo-app-loading
```
...
import { useFonts, Varta_300Light, Varta_400Regular, Varta_500Medium, Varta_600SemiBold, Varta_700Bold } from '@expo-google-fonts/varta';
