...
```sh
npx expo install @expo-google-fonts/fjalla-one expo-font
```
...
import { useFonts } from '@expo-google-fonts/fjalla-one/useFonts';
import { FjallaOne_400Regular } from '@expo-google-fonts/fjalla-one/400Regular';
