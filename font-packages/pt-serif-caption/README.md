...
```sh
npx expo install @expo-google-fonts/pt-serif-caption expo-font expo-app-loading
```
...
import { useFonts, PTSerifCaption_400Regular, PTSerifCaption_400Regular_Italic } from '@expo-google-fonts/pt-serif-caption';
