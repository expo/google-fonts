...
```sh
npx expo install @expo-google-fonts/fenix expo-font
```
...
import { useFonts } from '@expo-google-fonts/fenix/useFonts';
import { Fenix_400Regular } from '@expo-google-fonts/fenix/400Regular';
