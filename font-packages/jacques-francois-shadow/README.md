...
```sh
npx expo install @expo-google-fonts/jacques-francois-shadow expo-font
```
...
||||
|-|-|-|
|![JacquesFrancoisShadow_400Regular](./400Regular/JacquesFrancoisShadow_400Regular.ttf.png)||||
