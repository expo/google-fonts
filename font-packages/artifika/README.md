...
```sh
npx expo install @expo-google-fonts/artifika expo-font
```
...
import { useFonts } from '@expo-google-fonts/artifika/useFonts';
import { Artifika_400Regular } from '@expo-google-fonts/artifika/400Regular';
...
||||
|-|-|-|
|![Artifika_400Regular](./400Regular/Artifika_400Regular.ttf.png)||||
