# @expo-google-fonts/flow-circular
...
```sh
npx expo install @expo-google-fonts/flow-circular expo-font expo-app-loading
```
...
||||
|-|-|-|
|![FlowCircular_400Regular](./FlowCircular_400Regular.ttf.png)||||
