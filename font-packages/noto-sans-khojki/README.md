# @expo-google-fonts/noto-sans-khojki
...
```sh
npx expo install @expo-google-fonts/noto-sans-khojki expo-font expo-app-loading
```
...
import { useFonts, NotoSansKhojki_400Regular } from '@expo-google-fonts/noto-sans-khojki';
