import { FontLicenseTypes } from './constants';

export const licenseOverrides: [string[], { type: string; url?: string; content?: string }][] = [
  [
    [
      'Material Symbols',
  ...
  [
    ...
    {
      type: FontLicenseTypes.OFL,
      url: 'https://raw.githubusercontent.com/SorkinType/QLDSchoolHandAustralia/refs/heads/main/OFL.txt',
    },
  ],
  [
    ['Edu SA Hand'],
    {
      type: FontLicenseTypes.OFL,
      url: 'https://raw.githubusercontent.com/SorkinType/SASchoolHandAustralia/refs/heads/main/OFL.txt',
    },
  ],
  [
    ...
    {
      type: FontLicenseTypes.OFL,
      url: 'https://raw.githubusercontent.com/SorkinType/VICWANTSchoolhandAustralia/refs/heads/main/OFL.txt',
    },
  ],
  [
    ...
    {
      type: FontLicenseTypes.OFL,
      url: 'https://raw.githubusercontent.com/SorkinType/NSWACTSchoolHandAustralia/refs/heads/main/OFL.txt',
    },
  ],
  [
